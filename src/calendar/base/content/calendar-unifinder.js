...
function addItemsFromSingleCalendarInternal(eventArray) {
    var newItems = unifinderTreeView.eventArray.concat(eventArray.filter(isItemInFilter));
...
function addItemsFromCalendar(aCalendar, aAddItemsInternalFunc) {
    ...
    var refreshListener = {
        ...
        onGetResult: function rET_onGetResult(aCalendar,
                                              ...
                                              aCount,
                                              aItems) {
            refreshListener.mEventArray
            = refreshListener.mEventArray.concat(aItems);
        }
    };
    ...
    aCalendar.getItems(filter, 0, gStartDate, gEndDate, refreshListener);
}
