...
calDNDBaseObserver.prototype = {
    ...
    onDrop: function calDNDDrop(aEvent, aTransferData, aDragSession) {
        ...
        switch (bestFlavor.value) {
            case "text/calendar":
//@line 250 "/builds/tinderbox/Lt-Mozilla1.8/Darwin_8.7.0_Depend/mozilla/calendar/lightning/../base/content/calendar-dnd-listener.js"
                // Mac likes to convert all \r to \n, we need to reverse this.
                data = data.data.replace(/\n\n/g, "\r\n");
//@line 253 "/builds/tinderbox/Lt-Mozilla1.8/Darwin_8.7.0_Depend/mozilla/calendar/lightning/../base/content/calendar-dnd-listener.js"
