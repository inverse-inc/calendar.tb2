...
function build_osx {
    ...
    sed s/0.9/0.9.5/ install.rdf > install.rdf.tmp; mv -f install.rdf.tmp install.rdf
    ...
    cd $BASE/tmp
    zip -r ../output/lightning-0.9.5-inverse.mac.xpi chrome chrome.manifest components defaults install.rdf js platform timezones.sqlite
    cd $BASE; rm -rf ./tmp/*
...
function build_win32 {
    ...
    # We regenerate the xpi
    cd $BASE/tmp
    zip -r ../output/lightning-0.9.5-inverse.win32.xpi chrome chrome.manifest components defaults install.rdf js platform timezones.sqlite
    cd $BASE; rm -rf ./tmp/*
...
function build_linux {
    ...
    # We regenerate the xpi
    cd $BASE/tmp
    zip -r ../output/lightning-0.9.5-inverse.linux-i686.xpi chrome chrome.manifest components defaults install.rdf js platform timezones.sqlite
    cd $BASE; rm -rf ./tmp/*
...
function build_linux_x64 {
    ...
    # We regenerate the xpi
    cd $BASE/tmp
    zip -r ../output/lightning-0.9.5-inverse.linux-x86_64.xpi chrome chrome.manifest components defaults install.rdf js platform timezones.sqlite
    cd $BASE; rm -rf ./tmp/*
